...
class MessageHandler():
    ...
    def send_to_admin(cls, user_id: int, vk_id: int, last_order_id: int):
        ...
        messages = {
            "standard": f'Сообщение администратору о новом заказе имеет следующий вид: \n\n\
                          Новый заказ оформлен в {time_finished}. \n\
                          ...
                          Вложения: \n {attachment_links} \n\
                          {forward_message} \n\n\
                          В данном случае адресация настроена на вас для демонстрации, в реальном проекте \
                          сообщение адресуется администратору. ',
            "cdo": f'Сообщение администратору о новом заказе имеет следующий вид: \n\n\
                    Новый заказ оформлен в {time_finished}. \n\
                    Оформление заказа заняло: {order_spend_time} \n\
                    Ссылка на диалог: {dialog_link} \n\
                    -----------------------\n\
                    ...
                    В данном случае адресация настроена на вас для демонстрации, в реальном проекте \
                    сообщение адресуется администратору. ',
            "off_standard": f'Сообщение администратору о новом заказе имеет следующий вид: \n\n\
                             Новый заказ оформлен в {time_finished}. \n\
                             Оформление заказа заняло: {order_spend_time} \n\
                             Ссылка на диалог: {dialog_link} \n\
                             -----------------------\n\
                             ...
                             В данном случае адресация настроена на вас для демонстрации, в реальном проекте \
                             сообщение адресуется администратору. ',
            "off_cdo": f'Сообщение администратору о новом заказе имеет следующий вид: \n\n\
                         Новый заказ оформлен в {time_finished}. \n\
                         Оформление заказа заняло: {order_spend_time} \n\
                         Ссылка на диалог: {dialog_link} \n\
                         -----------------------\n\
        ...
        admin_id = vk_id  # для демо-версии перенаправим сообщение не администратору, а тестировщику =)
